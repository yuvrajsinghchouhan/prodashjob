...
gulp.task("flush", function () {
	...
	MongoClient.connect('mongodb://' + siteConfig.mongodb.username + ':' + siteConfig.mongodb.password + ':' siteConfig.mongodb.host + ':' + siteConfig.mongodb.port  + '/' + siteConfig.mongodb.database, function (err, db) {
